      ...
      <div className={styles.container}>
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            <Link href="/" aria-label="PitPet Store — página inicial" className={styles.logoLink}>
              <Image
        ...
        <div className={styles.bottom}>
          <p>
            O PitPet Store cuida do seu pet com amor, afeto e respeito. Todos os
            animais ficam livres, nunca em gaiolas, e recebem o mesmo carinho de
            casa.
          </p>
          <p className={styles.legal}>
            &copy; {new Date().getFullYear()} PitPet Store — Todos os direitos
            reservados
          </p>
        </div>
      </div>
